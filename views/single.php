                        ...
                        <?php while ( have_posts() ) : the_post();
                            ...
                            <div class="entry-content">
                                <div class="col-md-4">
                                    ...
                                    <div class="post-cat" title="<?php __( 'Post in category', 'fw' ) ?>"><?php echo $term_list; ?></div>
                                    
                                    <div class="social-share-entry"><?php echo __( 'Share', 'fw' ); ?>: 
                                        ...
                                        <table class="table"> 
                                            <tbody>
                                                ...
                                                <?php if (! empty(fw_get_db_post_option( get_the_ID(), 'post_photo_param' )['photo_shutter_speed'])) {
                                                    echo '<tr>';
                                                        echo '<td>'. __( 'SHUTTER SPEED', 'fw' ). '</td>';
